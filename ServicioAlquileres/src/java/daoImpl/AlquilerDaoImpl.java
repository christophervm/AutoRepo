...
ClienteDaoImpl clidao = new ClienteDaoImpl();
    ...
    public List<Alquiler> ListaAlquilerNoEnt() {
        ...
        List<Alquiler> lstDistrito = new ArrayList<Alquiler>();
         Reserva res = null;
        try {
            String sql = "SELECT * FROM TBAlquiler where FechaEntrega is null";
            PreparedStatement pstm = cn.prepareStatement(sql);
    ...
    @Override
    public Alquiler ListaAlquilerNoEntxPlaca(String placa) {
       
        Alquiler al = null;
         Reserva res = null;
        try {
            String sql = "SELECT * FROM TBAlquiler where FechaEntrega is null and Placa = ?";
            PreparedStatement pstm = cn.prepareStatement(sql);
           ...
           al = new Alquiler(cod,fechaini,fechaent,client,aut);
